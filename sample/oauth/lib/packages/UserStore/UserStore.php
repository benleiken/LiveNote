...
class UserStoreClient implements UserStoreIf {
  ...
  {
    $args = new edam_userstore_UserStore_getBootstrapInfo_args();
    $args->locale = $locale;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'edam_userstore_UserStore_getBootstrapInfo_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new edam_userstore_UserStore_getBootstrapInfo_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new edam_userstore_UserStore_getNoteStoreUrl_args();
    $args->authenticationToken = $authenticationToken;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'edam_userstore_UserStore_getNoteStoreUrl_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new edam_userstore_UserStore_getNoteStoreUrl_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
...
class edam_userstore_UserStore_getBootstrapInfo_args {
  static $_TSPEC;
...
class edam_userstore_UserStore_getBootstrapInfo_result {
  static $_TSPEC;
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new edam_userstore_BootstrapInfo();
...
class edam_userstore_UserStore_getNoteStoreUrl_args {
  static $_TSPEC;
...
class edam_userstore_UserStore_getNoteStoreUrl_result {
  static $_TSPEC;
